    ...
    <Container>
      <Header className="relative bg-cover bg-center text-white custom-header-height flex items-center justify-center">
        ...
        <div className="container mx-auto flex flex-col justify-center items-center py-1 md:py-2 px-6 z-10">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight font-Abril_Fatface mb-4 text-center text-shadow-lg animate-fade-in-up">
            Book Your Dream Trip
          </h1>
          <p className="text-lg md:text-xl lg:text-2xl font-semibold text-center text-shadow-md animate-fade-in-up animation-delay-200">
            Fill out the form below to start planning your adventure.
          </p>
        </div>
      </Header>
        ...
        <div className="container mx-auto px-6">
          ...
          <Form onSubmit={handleSubmit}>
            ...
            <div className="mb-6">
              ...
              <Input type="text" id="destination" name="destination" placeholder="Enter your destination" value={formData.destination} onChange={handleChange} />
            </div>
            <div className="mb-6">
              <label htmlFor="dates" className="block text-gray-700 text-sm font-bold mb-2">Travel Dates</label>
              <Input type="text" id="dates" name="dates" placeholder="Enter your travel dates" value={formData.dates} onChange={handleChange} />
            </div>
            <div className="mb-6">
              <label htmlFor="guests" className="block text-gray-700 text-sm font-bold mb-2">Number of Guests</label>
              <Input type="number" id="guests" name="guests" placeholder="Enter number of guests" value={formData.guests} onChange={handleChange} />
            </div>
            <div className="mb-6">
              <label htmlFor="message" className="block text-gray-700 text-sm font-bold mb-2">Additional Information</label>
              <TextArea id="message" name="message" placeholder="Enter any additional information" value={formData.message} onChange={handleChange} />
            </div>
