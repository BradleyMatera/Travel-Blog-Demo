        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="text-center">
              <img src="/img/tour-mountainHiking.jpg" alt="Mountain Hiking" className="w-full h-64 object-cover mb-4" />
            ...
            <div className="text-center">
              <img src="/img/tour-pyramids.jpg" alt="Pyramids Tour" className="w-full h-64 object-cover mb-4" />
            ...
            <div className="text-center">
              <img src="/img/tour-snorkel.jpg" alt="Snorkeling Adventure" className="w-full h-64 object-cover mb-4" />
